...
class TestClp(unittest.TestCase):
    def test_solve(self):
        ...
        np.testing.assert_equal(solver.status(), int(clp.Status.OPTIMAL))
    ...
    def _example() -> clp.Clp:
        ...
        solver.set_optimization_direction(clp.OptimizationDirection.MAXIMIZE)
        return solver
